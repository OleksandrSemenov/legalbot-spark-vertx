...
public interface TemplateNames {
    ...
    String MENU_BUTTON_CHANGE_LANG = "menu.button.change-lang";
    String WRONG_COMMAND = "command.wrong";
    String UNSUBSCRIBE = "command.unsubscribe";
    String SUBSCRIBE = "command.subscribe";
